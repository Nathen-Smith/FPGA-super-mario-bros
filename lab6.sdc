...
# Set False Path
#**************************************************************
set_false_path -from * -through * -to LEDR[?]
set_false_path -from [get_ports KEY*] -to * 
set_false_path -from [get_ports SW*] -to *
set_false_path -from [get_ports {DRAM_DQ* DRAM_*DQM}] -to *
set_false_path -from [get_ports {DRAM_ADDR* DRAM_BA* DRAM_RAS_N DRAM_CAS_N DRAM_WE_N DRAM_CKE DRAM_CS_N}] -to *
...
#**************************************************************
# set_input_delay -max -clock clk_dram_ext 1.6  [get_ports {DRAM_DQ* DRAM_*DQM}]
